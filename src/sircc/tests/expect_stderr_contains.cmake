...
#   -DEXPECT=<substring to find in stderr>
# Optional:
#   -DEXPECT2=<substring>
#   -DEXPECT3=<substring>
...
if(NOT DEFINED SIRCC)
  message(FATAL_ERROR "expect_stderr_contains.cmake: missing -DSIRCC")
endif()
if(NOT DEFINED ARGS)
  set(ARGS)
endif()
if(NOT DEFINED EXPECT)
  message(FATAL_ERROR "expect_stderr_contains.cmake: missing -DEXPECT")
endif()
if(NOT DEFINED EXPECT_EXIT_NONZERO)
  set(EXPECT_EXIT_NONZERO ON)
endif()
...
foreach(k EXPECT EXPECT2 EXPECT3)
  if(DEFINED ${k})
    ...
    string(FIND "${err}" "${exp}" idx)
    if(idx EQUAL -1)
      message(FATAL_ERROR "stderr did not contain '${exp}'\nstderr:\n${err}")
    endif()
  endif()
endforeach()
